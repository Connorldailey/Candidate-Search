...
const SavedCandidates = () => {
  ...
  const [sortBy, setSortBy] = useState<keyof Candidate | null>(null);
  ...
  // Function to retrieve potential candidates from localStorage
  ...
  // Function to handle sorting of candidates
